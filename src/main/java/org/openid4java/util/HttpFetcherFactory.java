...
public class HttpFetcherFactory {
  ...
  private final Supplier<HttpFetcher> _provider;

  public HttpFetcherFactory(Supplier<HttpFetcher> provider)
  {
      _provider = provider;
  }
  ...
  private static class HttpCacheProvider implements Supplier<HttpFetcher> {
